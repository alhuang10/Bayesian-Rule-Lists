...
def find_itemsets(current_tree, suffixes_found, output_list, total_transactions, min_support, antecedent_length):
    ...
    for attribute in reverse_ordering:
        ...
        if support >= min_support and attribute not in suffixes_found:
            ...
            if len(new_suffix_set) == antecedent_length:
            ...
            find_itemsets(conditional_tree, new_suffix_set, output_list, total_transactions, min_support, antecedent_length)
